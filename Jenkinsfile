pipeline {
    ...
    stages {
		...
		sh 'aws ec2 associate-iam-instance-profile --instance-id $(cat /Users/slver/.jenkins/workspace/ec-aws-s3/instance_id.txt) --iam-instance-profile ${params.INSTANCE_PROFILE_NAME}'
